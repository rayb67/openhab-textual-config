...
cp ${OPENHAB_SETUP_CONF}/things/ipcamera*.things .
cp ${OPENHAB_SETUP_CONF}/items/ipcamera*.items .
cp ${OPENHAB_SETUP_CONF}/rules/ipcamera*.rules .
cp ${OPENHAB_SETUP_CONF}/transform/ipcamera*.map .
cp ${OPENHAB_SETUP_CONF}/sitemaps/ipcamera*.sitemap .
