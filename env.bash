...
=======
export OPENHAB_PRD_HOSTNAME=srv-prod
export OPENHAB_PRD_IP=10.10.10.68
export OPENHAB_DEV_HOSTNAME=srv-dev
>>>>>>> ebc7a05 (Update README.md)
...
=======
if [ `hostname` == "srv-prod" ];
then
    echo "  env.bash - hostname srv-prod"
>>>>>>> ebc7a05 (Update README.md)
...
if [ `hostname` == "srv-dev" ];
then
    echo "  env.bash - hostname srv-dev"
>>>>>>> ebc7a05 (Update README.md)
