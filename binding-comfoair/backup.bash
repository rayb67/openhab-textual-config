...
cp ${OPENHAB_SETUP_CONF}/things/comfoair.things .
cp ${OPENHAB_SETUP_CONF}/items/comfoair.items .
cp ${OPENHAB_SETUP_CONF}/rules/comfoair*.rules .
cp ${OPENHAB_SETUP_CONF}/transform/comfoair*.map .
cp ${OPENHAB_SETUP_CONF}/sitemaps/comfoair.sitemap .
