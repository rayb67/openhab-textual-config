...
cp ${OPENHAB_SETUP_CONF}/things/mqtt_rctmon.things .
cp ${OPENHAB_SETUP_CONF}/items/mqtt_rctmon.items .
cp ${OPENHAB_SETUP_CONF}/rules/mqtt_rctmon.rules .
cp ${OPENHAB_SETUP_CONF}/sitemaps/mqtt_rctmon.sitemap .
cp ${OPENHAB_SETUP_CONF}/transform/mqtt_rctmon*.js .
