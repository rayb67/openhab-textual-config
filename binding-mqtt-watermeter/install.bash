...
cp ${DATAPATH}/mqtt_water*.items $OPENHAB_SETUP_CONF/items/.
cp ${DATAPATH}/mqtt_water*.sitemap $OPENHAB_SETUP_CONF/sitemaps/.
cp ${DATAPATH}/mqtt_water*.things $OPENHAB_SETUP_CONF/things/.
