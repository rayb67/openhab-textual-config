...
cp ${OPENHAB_SETUP_CONF}/things/mqtt_water*.things .
cp ${OPENHAB_SETUP_CONF}/items/mqtt_water*.items .
cp ${OPENHAB_SETUP_CONF}/rules/mqtt_water*.rules .
cp ${OPENHAB_SETUP_CONF}/sitemaps/mqtt_water*.sitemap .
#cp ${OPENHAB_SETUP_CONF}/transform/mqtt_water*.js .
