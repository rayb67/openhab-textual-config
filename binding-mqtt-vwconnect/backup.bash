...
cp ${OPENHAB_SETUP_CONF}/things/mqtt_vwc*.things .
cp ${OPENHAB_SETUP_CONF}/items/mqtt_vwc*.items .
cp ${OPENHAB_SETUP_CONF}/rules/mqtt_vwc*.rules .
cp ${OPENHAB_SETUP_CONF}/sitemaps/mqtt_vwc*.sitemap .
